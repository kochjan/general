...
# add standardizing: z-scoring and outlier filter to each data column, to make sure same scale

MODEL_NAME = 'som_stock4b'
SIGNALS = ['analyst','fmom','quality','iu','sentiment','value']
...
with open('bf.twn.expectAlpha_v3.monthly.train','rb') as infh:
