...
import time
import nipun_task.utility.sql_io as sql_io
...
for item2n in item2n_dict:
    c2 = requests.post(base_url, data={'__VIEWSTATE':viewstate, '__EVENTVALIDATION':eventvalidation, 'ctl00$ContentPlaceHolder1$hidLanguage':'E', 'ctl00$ContentPlaceHolder1$ddlPeriod':'M', 'ctl00$ContentPlaceHolder1$ddlDateBeg':199001, 'ctl00$ContentPlaceHolder1$ddlDateEnd':201507,\
...
item2n:'on'}).content
    ...
    sql_io.write_frame(res_df[['Product', 'Year_Month', 'Production Volume', 'Production Value NT$ 1000',\
       ...
       'Inventory Volume', 'Inventory Value NT$ 1000']], 'dwang..twn_comm', if_exists='append')
