...
base_url = 'http://dmz9.moea.gov.tw/gmweb/investigate/InvestigateEC.aspx?lang=E'
db_name = 'dwang..twn_manuf_survey'
beg_month = '1990Q1'
period='Q'
...
item2n:'on'}
    ...
    sql_io.write_frame(res_df, db_name, if_exists='append', bulk='off', unicode=True)
